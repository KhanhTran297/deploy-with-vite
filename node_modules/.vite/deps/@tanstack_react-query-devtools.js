...
function useLocalStorage(key, defaultValue) {
  ...
  const setter = React11.useCallback((updater) => {
    setValue((old) => {
      let newVal = updater;
...
var simpleRules = [
  ...
  simpleTransformation(isError2, "Error", function(v, superJson) {
    var baseError = {
      name: v.name,
      message: v.message
    };
...
var ThemeContext = React12.createContext(defaultTheme);
function ThemeProvider({
  theme,
  ...rest
}) {
  return React12.createElement(ThemeContext.Provider, _extends({
    value: theme
  }, rest));
}
function useTheme() {
...
function useMediaQuery(query) {
  const [isMatch, setIsMatch] = React13.useState(() => {
...
function styled(type, newStyles, queries = {}) {
  return React14.forwardRef(({
    ...
    return React14.createElement(type, {
      ...rest,
      style: {
...
function useIsMounted() {
  const mountedRef = React14.useRef(false);
  const isMounted = React14.useCallback(() => mountedRef.current, []);
  React14.useEffect(() => {
...
var CopyButton = ({
  ...
  const [copyState, setCopyState] = React16.useState("NoCopy");
  return React16.createElement("button", {
  ...
  }, copyState === "NoCopy" ? React16.createElement(Copier, null) : copyState === "SuccessCopy" ? React16.createElement(CopiedCopier, null) : React16.createElement(ErrorCopier, null));
};
...
var Copier = () => React16.createElement("span", {
...
var ErrorCopier = () => React16.createElement("span", {
...
var CopiedCopier = () => React16.createElement("span", {
...
var DefaultRenderer = ({
  ...
  const [expandedPages, setExpandedPages] = React16.useState([]);
  return React16.createElement(Entry, {
    key: label
  }, subEntryPages.length ? React16.createElement(React16.Fragment, null, React16.createElement(ExpandButton, {
    onClick: () => toggleExpanded()
  }, React16.createElement(Expander, {
    expanded
  }), " ", label, " ", React16.createElement(Info, null, String(type).toLowerCase() === "iterable" ? "(Iterable) " : "", subEntries.length, " ", subEntries.length > 1 ? "items" : "item")), copyable ? React16.createElement(CopyButton, {
    value
  }) : null, expanded ? subEntryPages.length === 1 ? React16.createElement(SubEntries, null, subEntries.map(handleEntry)) : React16.createElement(SubEntries, null, subEntryPages.map((entries, index) => React16.createElement("div", {
    key: index
  }, React16.createElement(Entry, null, React16.createElement(LabelButton, {
    onClick: () => setExpandedPages((old) => old.includes(index) ? old.filter((d) => d !== index) : [...old, index])
  }, React16.createElement(Expander, {
    expanded
  }), " [", index * pageSize, " ...", " ", index * pageSize + pageSize - 1, "]"), expandedPages.includes(index) ? React16.createElement(SubEntries, null, entries.map(handleEntry)) : null)))) : null) : React16.createElement(React16.Fragment, null, React16.createElement(Label, null, label, ":"), " ", React16.createElement(Value, null, displayValue(value))));
};
...
function Explorer({
  ...
  const [expanded, setExpanded] = React16.useState(Boolean(defaultExpanded));
  const toggleExpanded = React16.useCallback(() => setExpanded((old) => !old), []);
  ...
  return renderer({
    handleEntry: (entry) => React16.createElement(Explorer, _extends({
      key: entry.label,
      value,
      renderer,
      copyable
...
function Logo(props) {
  return React17.createElement("svg", _extends({
    width: "40px",
    height: "40px",
    viewBox: "0 0 190 190",
    version: "1.1"
  }, props), React17.createElement("g", {
    stroke: "none",
    strokeWidth: "1",
    fill: "none",
    fillRule: "evenodd"
...
function ReactQueryDevtools({
  ...
  const [isResolvedOpen, setIsResolvedOpen] = React18.useState(false);
  const [isResizing, setIsResizing] = React18.useState(false);
  ...
  if (!isMounted())
    return null;
  return React18.createElement(Container, {
    ref: rootRef,
    className: "ReactQueryDevtools",
    "aria-label": "React Query Devtools"
  }, React18.createElement(ThemeProvider, {
    theme: defaultTheme
  }, React18.createElement(ReactQueryDevtoolsPanel, _extends({
    ref: panelRef,
    context,
    styleNonce,
    position: panelPosition,
  ...
  }))), !isResolvedOpen ? React18.createElement("button", _extends({
    type: "button"
  }, otherToggleButtonProps, {
  ...
  }), React18.createElement(Logo, {
    "aria-hidden": true
  }), React18.createElement(ScreenReader, {
    text: "Open React Query Devtools"
  })) : null);
}
var useSubscribeToQueryCache = (queryCache, getSnapshot, skip = false) => {
  return (0, import_shim2.useSyncExternalStore)(React18.useCallback((onStoreChange) => {
    if (!skip)
...
var ReactQueryDevtoolsPanel = React18.forwardRef(function ReactQueryDevtoolsPanel2(props, ref) {
  const {
    isOpen = true,
    styleNonce,
    setIsOpen,
  ...
  const sortFn = React18.useMemo(() => sortFns[sort], [sort]);
  ...
  const [isMockOffline, setMockOffline] = React18.useState(false);
  return React18.createElement(ThemeProvider, {
    theme: defaultTheme
  }, React18.createElement(Panel, _extends({
    ref,
  ...
  }), isOpen && React18.createElement("div", {
    style: {
      flex: "1 1 500px",
      minHeight: "40%",
      maxHeight: "100%",
  ...
  }, React18.createElement(QueryStatusCount, {
    queryCache
  }), position && onPositionChange ? React18.createElement(Select, {
    ...
    value: "left"
  }, "Left"), React18.createElement("option", {
    value: "right"
  }, "Right"), React18.createElement("option", {
    value: "top"
  }, "Top"), React18.createElement("option", {
    value: "bottom"
  }, "Bottom")) : null), React18.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center"
    }
  ...
  }, Object.keys(sortFns).map((key) => React18.createElement("option", {
    key,
    value: key
  }, "Sort by ", key))), React18.createElement(Button, {
    type: "button",
  ...
  }, baseSort === 1 ? "⬆ Asc" : "⬇ Desc"), React18.createElement(Button, {
    type: "button",
    onClick: () => {
      if (isMockOffline) {
    ...
    fill: "none"
  }, isMockOffline ? React18.createElement(React18.Fragment, null, React18.createElement("path", {
    stroke: "none",
    d: "M0 0h24v24H0z",
    fill: "none"
  }), React18.createElement("line", {
    x1: "12",
    y1: "18",
    x2: "12.01",
    y2: "18"
    ...
    x2: "21",
    y2: "21"
  })) : React18.createElement(React18.Fragment, null, React18.createElement("path", {
    stroke: "none",
    d: "M0 0h24v24H0z",
    fill: "none"
  }), React18.createElement("line", {
    ...
    return React18.createElement(QueryRow, {
  ...
  }))), activeQueryHash && isOpen ? React18.createElement(ActiveQuery, {
    activeQueryHash,
    queryCache,
    queryClient
  }) : null, showCloseButton ? React18.createElement(Button, _extends({
    type: "button",
    "aria-controls": "ReactQueryDevtoolsPanel",
    "aria-haspopup": "true",
    "aria-expanded": "true"
...
var ActiveQuery = ({
  ...
  const handleRefetch = () => {
    ...
    promise == null ? void 0 : promise.catch(noop2);
  };
  if (!activeQuery || !activeQueryState) {
    return null;
  }
  return React18.createElement(ActiveQueryPanel, null, React18.createElement("div", {
    style: {
      padding: ".5em",
      background: defaultTheme.backgroundAlt,
      position: "sticky",
  ...
  }, "Query Details"), React18.createElement("div", {
    style: {
      padding: ".5em"
    }
  }, React18.createElement("div", {
  ...
  }, React18.createElement(Code, {
    style: {
      lineHeight: "1.8em"
    }
  }, React18.createElement("pre", {
    style: {
      margin: 0,
      padding: 0,
      overflow: "auto"
    }
  }, displayValue(activeQuery.queryKey, true))), React18.createElement("span", {
    style: {
      padding: "0.3em .6em",
      borderRadius: "0.4em",
      fontWeight: "bold",
  ...
  }, getQueryStatusLabel(activeQuery))), React18.createElement("div", {
    style: {
      marginBottom: ".5em",
      display: "flex",
      alignItems: "center",
  ...
  }, "Observers: ", React18.createElement(Code, null, observerCount)), React18.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      justifyContent: "space-between"
    }
  }, "Last Updated:", " ", React18.createElement(Code, null, new Date(activeQueryState.dataUpdatedAt).toLocaleTimeString()))), React18.createElement("div", {
    style: {
      background: defaultTheme.backgroundAlt,
      padding: ".5em",
      position: "sticky",
  ...
  }, "Actions"), React18.createElement("div", {
    style: {
      padding: "0.5em"
    }
  }, React18.createElement(Button, {
  ...
  }, "Refetch"), " ", React18.createElement(Button, {
    type: "button",
  ...
  }, "Invalidate"), " ", React18.createElement(Button, {
    type: "button",
    onClick: () => queryClient.resetQueries(activeQuery),
    style: {
      background: defaultTheme.gray
    }
  }, "Reset"), " ", React18.createElement(Button, {
    type: "button",
    onClick: () => queryClient.removeQueries(activeQuery),
    style: {
      background: defaultTheme.danger
    }
  }, "Remove")), React18.createElement("div", {
    style: {
      background: defaultTheme.backgroundAlt,
      padding: ".5em",
      position: "sticky",
  ...
  }, "Data Explorer"), React18.createElement("div", {
    style: {
      padding: ".5em"
    }
  }, React18.createElement(Explorer, {
    label: "Data",
  ...
  }, "Query Explorer"), React18.createElement("div", {
    style: {
      padding: ".5em"
    }
  }, React18.createElement(Explorer, {
...
var QueryStatusCount = ({
  ...
  return React18.createElement(QueryKeys, null, React18.createElement(QueryKey, {
    style: {
      background: defaultTheme.success,
      opacity: hasFresh ? 1 : 0.3
    }
  }, "fresh ", React18.createElement(Code, null, "(", hasFresh, ")")), " ", React18.createElement(QueryKey, {
    style: {
      background: defaultTheme.active,
      opacity: hasFetching ? 1 : 0.3
    }
  }, "fetching ", React18.createElement(Code, null, "(", hasFetching, ")")), " ", React18.createElement(QueryKey, {
    style: {
      background: defaultTheme.paused,
      opacity: hasPaused ? 1 : 0.3
    }
  }, "paused ", React18.createElement(Code, null, "(", hasPaused, ")")), " ", React18.createElement(QueryKey, {
    style: {
      background: defaultTheme.warning,
      color: "black",
      textShadow: "0",
  ...
  }, "stale ", React18.createElement(Code, null, "(", hasStale, ")")), " ", React18.createElement(QueryKey, {
    style: {
      background: defaultTheme.gray,
      opacity: hasInactive ? 1 : 0.3
    }
  }, "inactive ", React18.createElement(Code, null, "(", hasInactive, ")")));
};
var QueryRow = React18.memo(({
  queryKey,
  setActiveQueryHash,
  activeQueryHash,
  queryCache
  ...
  }, observerCount), isDisabled ? React18.createElement("div", {
    style: {
      flex: "0 0 auto",
      height: "2em",
      background: defaultTheme.gray,
  ...
  }, "disabled") : null, React18.createElement(Code, {
    style: {
      padding: ".5em"
    }
  }, "" + queryHash));
